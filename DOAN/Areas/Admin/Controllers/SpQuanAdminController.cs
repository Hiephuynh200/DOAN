...
{
    public class SpQuanAdminController : Controller
    {
        // GET: Admin/SpQuanAdmin
        ...
        {
            var listAo = data.SanPham.Where(x => x.MaLoai == 1002).ToList();
            return View(listAo);
        }
        ...
        public ActionResult Edit(int id, FormCollection collection)
        {
            ...
            else
            {
                ...
                UpdateModel(sp);
                data.SaveChanges();
                return RedirectToAction("SpQuan", "spQuanAdmin");
            }
            return this.Edit(id);
        }
    }
